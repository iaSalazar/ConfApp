...
import com.demo.platziconf.model.Ubication
...
class UbicationDetailDialogFragment : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        super.onViewCreated(view, savedInstanceState)
        toolbarUbication.navigationIcon = ContextCompat.getDrawable(view.context, R.drawable.close)
        ...
        tvUbicationName.text = ubication.name
        tvUbicationAdress.text = ubication.address
        tvUbicationPhone.text = ubication.phone
        tvUbicationWeb.text = ubication.website
